package com.mytao.manager.mapper;

import com.mytao.manager.entity.TbItemParam;
import com.mytao.manager.entity.TbItemParamExample;
...
public interface TbItemParamMapper {
    ...
    List<TbItemParam> selectWithCatName();
}